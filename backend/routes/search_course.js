...
router.post('/', function(req, res, next) {
    ...
    var q = {name:{$regex:new RegExp(req.body.course_name)},tutor:{$regex:new RegExp(req.body.tutor_name)},subject:subject,price:{$gte:parseInt(req.body.minprice),$lte:parseInt(req.body.maxprice)}}
